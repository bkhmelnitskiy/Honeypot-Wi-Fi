<template>
    <svg width="114" height="114" viewBox="0 0 114 114" fill="none" stroke="currentColor" stroke-width="5" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M3 60.5L16.5 47"/>
        <path d="M28.5 47L51 69.5"/>
        <path d="M64 69L95.5 37.5V54.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M78 37.5H95.5" stroke-linecap="round"/>
    </svg>
</template>